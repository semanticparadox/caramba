...
// On success the JSON is the import metadata:
// { "name": string?, "servers": [ { "id", "name", "type", "server", "port",
// "country" } ] }. "id" is the mihomo proxy name and is what CarambaUp takes as
// serverID to pin the CARAMBA selector to one node.
