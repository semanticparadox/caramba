...
abstract final class AppRoute {
  ...
  /// Списки доменов «через VPN только эти» / «эти мимо VPN».
  ///
  /// Заменил `/split-tunnel` («Улучшения»). Тот экран держал три независимые
  /// вещи разом — блок рекламы, списки сайтов и режим страны; режим забрала
  /// Главная, реклама уехала в Настройки, и от вкладки остались списки. Путь
  /// теперь называет ровно то, что за ним лежит, и живёт под настройками,
  ...
  /// («Улучшения» из того отчёта — экран, растворённый позже: реклама уехала
  /// в Настройки, списки сайтов стали [siteRules], режим — на Главную.)
  ///
