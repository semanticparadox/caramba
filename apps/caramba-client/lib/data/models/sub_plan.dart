...
class FamilyInvite {
  ...
  /// Ссылка приглашения. Её присылает панель; без неё показываем код, а не
  /// ссылку на чужого бота.
  String inviteLinkFor(String botUrl) {
    final bot = botUrl.trim();
    return bot.isEmpty ? code : '$bot?start=family-$code';
  }
