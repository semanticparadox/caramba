/// Кнопка автоподбора на «Подключении».
///
...
///
/// Словарь общий с экраном «Серверы» (открывается со строки «Сервер») и с
/// баннером «Подключения»: «не в силе» — выбор не исполняется (замер при этом
/// свежий), «устарело» — устарел сам замер.
...
/// Отдельная кнопка автоподбора под группой строк «Подключения».
class AutopilotButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // экрана автонастройки: значит состояние «идёт» с «Подключения»
    // ДОСТИЖИМО и эмулировать его нечем и незачем.
