...
/// сайтов и выбор режима. Режим и блок рекламы владелец оставил в Настройках
/// (раздел «Правила трафика»), и оставшийся экран из трёх разделов стал бы
/// оболочкой с одним.
...
///     настраивается здесь и в разделе «Правила трафика».
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  // человек выбрал режим в Настройках, а трафик идёт по
                  // списку
                  ...
                  if (cfg.allowSitesActive) ...[
                    ...
                    const InlineBanner(
                      ...
                      glyph: Lucide.alert,
                      text:
                          'Режим, выбранный в Настройках, сейчас НЕ '
  ...
  List<Widget> _bypassSection(CoreConfigNotifier cfgN) {
    ...
    return <Widget>[
      ...
      Text(
        ...
        'режиму, выбранному в Настройках.',
        style: AppType.bodySm.copyWith(color: c.textLow),
      ),
    ];
  }
