/// Подписи раздела «Правила трафика» в Настройках и — главное — правило, по
/// которому здесь вообще позволено писать «включено».
///
/// Имя файла осталось от вкладки «Улучшения», где эти подписи жили раньше;
/// вкладка растворена (реклама и режим — строками раздела «Правила трафика»,
/// списки сайтов — на «Правилах по сайтам»), а правило переезда не пережило
...
///
/// Режим здесь не называется НАМЕРЕННО, хотя раньше сводка «Улучшений»
/// начиналась именно с него: у режима своя строка «Режим» прямо над этой, в
/// том же разделе «Правила трафика». Повтор создал бы два места для одной
/// величины — ровно то, что владелец и просил убрать.
///
