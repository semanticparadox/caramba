...
class SettingsScreen extends ConsumerWidget {
          ...
          children: [
            ...
            RowsGroup(children: [
              ...
              CRow(
                label: 'Kill-switch',
                trailing: Switch(
                    value: cfg.killSwitch, onChanged: cfgN.setKillSwitch),
              ),
              CRow(
                label: 'Автоподключение',
                trailing: Switch(
                    value: cfg.autoConnect, onChanged: cfgN.setAutoConnect),
              ),
            ]),
            ...
            RowsGroup(children: [
              ...
              CRow(
                label: 'Fake-IP',
                trailing:
                    Switch(value: cfg.fakeIp, onChanged: cfgN.setFakeIp),
              ),
              CRow(
                label: 'IPv6',
  ...
  Future<int?> _pickCore(BuildContext context, String title, String sub,
      List<CoreOption> opts, int selected) {
