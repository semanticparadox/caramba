...
///
/// Показывается на «Подключении», где уже живёт атмосферный слой. Карточка
/// стоит НИЖЕ дайла, в блоке карточек: слой зарегистрирован на измеренную
/// геометрию шапки и дайла, и любой сдвиг вверх ломает его инвариант,
/// поэтому высота шапки остаётся прежней (DESIGN.md 4.2, test/atmosphere).
///
