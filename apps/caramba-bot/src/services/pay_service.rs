...
impl PayService {
    ...
    pub async fn create_cryptobot_invoice(
        ...
        let resp: InvoiceResp = self
            .api
            .post(
                &format!("/payments/{}/cryptobot", user_id),
                &InvoiceReq {
                    amount,
                    payment_type,
                },
    ...
    pub async fn create_nowpayments_invoice(
        ...
        let resp: InvoiceResp = self
            .api
            .post(
                &format!("/payments/{}/nowpayments", user_id),
                &InvoiceReq {
                    amount,
                    payment_type,
                },
    ...
    pub async fn create_crystalpay_invoice(
        ...
        let resp: InvoiceResp = self
            .api
            .post(
                &format!("/payments/{}/crystalpay", user_id),
                &InvoiceReq {
                    amount,
                    payment_type,
                },
    ...
    pub async fn create_stripe_session(
        ...
        let resp: InvoiceResp = self
            .api
            .post(
                &format!("/payments/{}/stripe", user_id),
                &InvoiceReq {
                    amount,
                    payment_type,
                },
