...
mod tests {
    ...
    fn test_relay_outbound_uses_target_shadowsocks_inbound_port_and_method() {
        ...
        assert_eq!(
            relay_out.password,
            expected_relay_password("relay-token", 2)
        );
    ...
    fn test_relay_chain_intermediate_node_has_correct_inbound_and_outbound_auth() {
        ...
        assert_eq!(
            relay_out.password,
            expected_relay_password("middle-token", 3)
        );
        ...
        assert_eq!(
            hashed_user.password,
            expected_relay_password("upstream-token", 2)
        );
    ...
    fn test_relay_auth_mode_parsing_defaults_to_dual() {
        ...
        assert_eq!(
            RelayAuthMode::from_setting(Some("hashed")),
            RelayAuthMode::V1
        );
        assert_eq!(
            RelayAuthMode::from_setting(Some("dual")),
            RelayAuthMode::Dual
        );
        assert_eq!(RelayAuthMode::from_setting(None), RelayAuthMode::Dual);
        assert_eq!(
            RelayAuthMode::from_setting(Some("unknown")),
            RelayAuthMode::Dual
        );
    }
