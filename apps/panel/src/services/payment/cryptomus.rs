...
impl PaymentAdapter for CryptomusAdapter {
    async fn create_invoice(&self, user_id: i64, amount_usd: f64, payment_type: PaymentType) -> Result<String> {
        ...
        let body_json = json!({
            ...
            "url_return": "https://t.me/exarobot_bot",
