...
INSERT INTO settings (key, value) VALUES ('auto_sni_rotation_interval_hours', '24') ON CONFLICT (key) DO NOTHING;

-- Add setting for Custom Deny Patterns (default includes ovh.net, duckdns.net)
INSERT INTO settings (key, value) VALUES ('sni_scanner_deny_patterns', 'ovh.net,duckdns.net') ON CONFLICT (key) DO NOTHING;
